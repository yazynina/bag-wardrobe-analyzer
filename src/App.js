                          ...
                          <div key={index} className="bg-white rounded-xl p-6 shadow-md border-l-4 border-green-500">
                            <div className="flex items-start justify-between mb-2">
                              <h3 className="text-xl font-semibold text-gray-900">{rec.type}</h3>
                                                      <span className={
                                                                                      rec.priority === 'high' ? 'bg-red-100 text-red-700 px-3 py-1 rounded-full text-sm font-medium' :
                                                                                      rec.priority === 'medium' ? 'bg-yellow-100 text-yellow-700 px-3 py-1 rounded-full text-sm font-medium' :
