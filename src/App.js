...
const BagWardrobeAnalyzer = () => {
                ...
                const fetchRecommendationImages = async (recommendations) => {
                                        ...
                                        recommendations.forEach((_, index) => { newLoadingImages[index] = true; });
                                                                        ...
                                                                        try {
                                                                                                                ...
                                                                                                                if (response.ok) {
                                                                                                                                                                ...
                                                                                                                                                                if (data.images && data.images.length > 0) {
                                                                                                                                                                                                                        setRecImages(prev => ({ ...prev, [i]: data.images }));
                                                                                                                                                                                                                }
                                                                                                                        }
                                                                                } catch (error) {
                                                                                                                console.error('Image search error for rec ' + i + ':', error);
                                                                                }
                                        ...
                                        try {
                                                                        ...
                                                                        if (jsonMatch) {
                                                                                                                ...
                                                                                                                if (parsedAnalysis.recommendations && parsedAnalysis.recommendations.length > 0) {
                                                                                                                                                                fetchRecommendationImages(parsedAnalysis.recommendations);
                                                                                                                        }
                                                                                } else {
                ...
                const estimateBagValue = async (bagId) => {
                                        ...
                                        try {
                                                                        const response = await fetch("/api/analyze", {
                                                                                                                ...
                                                                                                                body: JSON.stringify({
                                                                                                                                                                apiKey,
                                                                                                                                                                bags: [{ id: bag.id, image: bag.image, brand: bag.brand, model: bag.model, condition: bag.condition }],
                                        ...
                                        {isLoading ? (
                                                                                                <div className="h-48 bg-gradient-to-br from-green-50 to-emerald-100 flex items-center justify-center">
                                                                                                        <div className="text-center">
                                                                                                                ...
                                                                                                                <p className="text-sm text-green-600">Finding images...</p>
                                                </div>
                                                </div>
                                                                                        ) : images.length > 0 ? (
                                                                                                <div className="flex overflow-x-auto gap-1 bg-gray-100">
                                                {images.slice(0, 3).map((img, imgIdx) => (
                                                                                                                        <div key={imgIdx} className="flex-shrink-0 w-1/3 min-w-[120px]">
                                                                                                                                <img
                                                                                                                                                        src={img.url}
                                                                                                                                                        alt={img.alt || rec.type}
                                                                        ...
                                                                        />
                                                                                                ...
                                                                                                <div className="h-48 bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 flex items-center justify-center">
                                                                                                        <div className="text-center">
                                                                                                                <ShoppingBag className="w-12 h-12 text-green-300 mx-auto mb-2" />
                                                                                                                <p className="text-sm text-green-400">Visual reference</p>
                                                </div>
                                                </div>
                                        )}
</div>
...
{rec.priority} priority
                                        ...
                                        <p className="text-gray-600 text-lg mb-3">{rec.reason}</p>

{rec.suggestedBrands && rec.suggestedBrands.length > 0 && (
                                                        <div className="flex flex-wrap gap-2 mb-4">
{rec.suggestedBrands.map((brand, bIdx) => (
                                                                        <span key={bIdx} className="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm font-medium">
        {brand}
        </span>
                                                                                 ))}
</div>
